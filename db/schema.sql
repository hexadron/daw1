...
create table Usuario (
  ...
  nombres varchar(255) nor null,
  apellidos varchar(255) nor null,
...
create table Requerimiento (
  ...
  idEstadoRequerimiento int not nul references EstadoRequerimiento,
  idDesarrollador int not nul references Desarrollador
);
